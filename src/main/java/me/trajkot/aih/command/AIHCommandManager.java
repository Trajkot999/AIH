            ...
            if(args.length > 0) {
                if (args[0].contains("help") || args[0].contains("command")) {
                    if(sender instanceof Player) {
                        ...
                        sender.sendMessage(prefix + " List of available commands:");
                        sender.sendMessage("/aih alerts - Enable/Disable alerts");
                        sender.sendMessage("/aih reload - Reloads config");
                        sender.sendMessage("/aih violations <player> - Checks total player violations");
                    }
                    return true;
                    ...
                    if(sender instanceof Player) {
                        ...
                        sender.sendMessage("[AIH] This command cannot be executed from console!");
                    }
                    return true;
                    ...
                    if(sender instanceof Player) {
                        ...
                        sender.sendMessage("[AIH] Unknown command!");
                        sender.sendMessage("[AIH] List of available commands:");
                        sender.sendMessage("/aih alerts - Enable/Disable alerts");
                        sender.sendMessage("/aih reload - Reloads config");
                        sender.sendMessage("/aih violations <player> - Checks total player violations");
                    }
